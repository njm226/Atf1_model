...
from UtoM import t_loop
import UtoM
import importlib
importlib.reload(UtoM)
import pandas as pd
...
#    loc = glo_loc[1]
    ...
    alpha1 = X*(len(mt_region))#-np.sqrt(len(mt_region)-153))
    ...
    beta5 = 55*len(mt_region)#13.5*len(mt_region)#15*len(mt_region)#
