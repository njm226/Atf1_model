...
# save state_list
with open('UtoM_atf1_away_together_on_S30.txt', 'wb') as F:
    pickle.dump(EcoRV_total_small, F)
    
# save state_list
with open('UtoM_atf1_away_together_off_S30.txt', 'wb') as F:
...
plt.savefig("UtoM_Atf1_away_together_cenH_S30.pdf")
